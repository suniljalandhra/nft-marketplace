...
contract NFTMarket is ReentrancyGuard {
    ...
    // function to buy a nft from marketPlace
    // Transfer Ownership of a nft 
    function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
        uint price = idToMarketItem[itemId].price;
        uint tokenId = idToMarketItem[itemId].tokenId;
        require(msg.value == price, "Amount submitted is not equall to the requested price");
    ...
    // this function will give all the unsold NFTs 
    ...
    // this will give the nfts that user has created 
